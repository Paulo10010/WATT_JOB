...
import OptionCard from './CardSeleção'; // Importa o cartão reutilizável
import styles from './ETAPAS.module.css'; // Importa nossos estilos
import Logo from '../assets/LOGO.jpg';
import ArmazemIcon from '../assets/ARMAZEM.png';
      ...
      <div className={styles.modalOverlay} onClick={handleClose}>
        <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.optionsContainer}>
            <OptionCard 
              title="A" 
              imageUrl={ArmazemIcon} 
              onClick={() => handleWarehouseSelect('A')}
              isSelected={selectedWarehouse === 'A'}
            />
            <OptionCard 
              title="B" 
              imageUrl={ArmazemIcon} 
